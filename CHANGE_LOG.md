...
### R7 — 审码五维：新增健壮性扫描 (2026-06-23)

**核心变更**:
- **审码五维**: 在安全、性能、可读、正确之外新增健壮性维度，覆盖异常输入、依赖失败、超时重试、降级恢复等风险
- **风险预警扩展**: 致人术风险预警新增健壮性扫描，审查/审计验证标准同步纳入健壮性发现
- **发布同步**: 版本升级至 v23.2.0，同步 compiler、标准版、英文版、README 与全平台分发产物

**同步范围**: compiler/SKILL_META.md + compiler/COMPILER.md + compiler/VALIDATOR.md + tools/progressive.py + skills/* + README* + 全平台分发
