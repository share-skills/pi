...
```
  ...
  ║   iterate.md   ║     ║  COMPILER.md   ║     ║ eval_criteria  ║     ║ DISTRIBUTE.md  ║     ║ TRANSLATE.md   ║
  ╚═══════════════╝     ╚═══════════════╝     ╚═══════════════╝     ╚═══════════════╝     ╚═══════════════╝
         │                      │                      │                      │                      │
    SKILL_META.md          SKILL.md              Eval通过率             6 平台版本             英文版产物
    (迭代真源)           (编译精简)             (≥8/9场景)            (按平台适配)           (行为等价)
```
...
用户提出改进方向
   ...
   └────┬─────┘
        ...
        ▼
   ┌──────────┐
   │ P2.5 Eval │  benchmark/eval_criteria.md
   │           │  9场景×3条件×2runs
   │ 验证 →    │
   │ ≥8/9通过  │
   └────┬──────┘
