...
<p>
  ...
  <img src="https://img.shields.io/badge/Copilot_CLI-000?style=flat-square&logo=github&logoColor=white" alt="Copilot CLI">
  <img src="https://img.shields.io/badge/Qwen_Code-FF6A00?style=flat-square&logo=alibaba-cloud&logoColor=white" alt="Qwen Code">
  <img src="https://img.shields.io/badge/Windsurf-06B6D4?style=flat-square" alt="Windsurf">
  <img src="https://img.shields.io/badge/Trae-FF4500?style=flat-square" alt="Trae">
...
| 🐺🐯 狼虎 | 直言/破伪 | 假设未验证 / 风险已知而未言 | 深入事实，消除偏差；风险不说破，等于共谋 |
| 🦁 狮 | 奋战 | 即将放弃 | 决战时刻，聚力破局 |
| 🐎 马 | 竞速 | 效率低下 | 即验即交，附输出 |
| 🐂 牛 | 坚韧 | 任务艰难 | 迎难不避，坚韧以行 |
| 🦈 鲨 | 搜索/潜搜 | 没搜就猜 / 深层隐患被回避 | 搜乃决断之粮；潜入水底，探测暗流 |
| 🐝 蜂 | 突击 | 终极冲刺 | 全原型协同出击 |
| 🦊 狐 | 审慎 | 质量偏低 | 审视产出，确保质量 |
| 🐲 龙 | 极限 | 极限突破 | 全力穷尽 |
...
| 式 | 名 | 要义 | 触发 |
|---|-----|------|------|
| 一 | 💭 **明链** | 思维链三档显式输出（🏊🏻1句/🏋️四步/🐲九令） | 标准/深度强制，轻量按需 |
...
<details>
<summary><b>其他平台（Windsurf / Trae / Augment / COPAW / Iflow / Qoder）</b></summary>
...
> 了解可视化背后的设计理念：[为什么 PI 有效](docs/WHY_PI_WORKS.md) · [设计哲学](docs/DESIGN_PHILOSOPHY.md) · [为什么需要编译器](docs/WHY_COMPILER.md) · [为什么要可视化](docs/WHY_VISUALIZE.md)
